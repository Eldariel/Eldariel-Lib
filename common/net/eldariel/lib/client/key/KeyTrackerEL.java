package net.eldariel.lib.client.key;
...
/**
 * Base class for a key tracker. Contains some helper methods for creating keybindings and checking for modifier key presses.
 * 
 ...
 *
 */
public abstract class KeyTrackerEL {

	final String modId;
	
	public KeyTrackerEL(String modId) {
	 ...
	 */
	protected KeyBinding createBinding(String name, IKeyConflictContext keyConflictContext, KeyModifier keyModifier, int keyCode) {
