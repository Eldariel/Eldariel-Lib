...
public class BlockContainerEL extends BlockContainer implements IRegistryObject, IHasSubtypes {

	protected final int subBlockCount;
	protected String blockName;
	protected String modId;
	
	protected BlockContainerEL(int subBlockCount, String modId, String name, Material material) {
