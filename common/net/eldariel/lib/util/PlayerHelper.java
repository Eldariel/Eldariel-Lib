...
public class PlayerHelper {
	...
	/**
	 * Gives the player an item. If it can't be given directly, it spawns an EntityItem. The version allows an exact
	 * position to be given.
	 */
	public static void giveItem(EntityPlayer player, ItemStack stack, double posX, double posY, double posZ) {
	...
	public static void removeItem(EntityPlayer player, ItemStack stack) {
		...
		List<NonNullList<ItemStack>> inventories = Lists.newArrayList(player.inventory.mainInventory, player.inventory.offHandInventory, player.inventory.armorInventory);
	...
	public static ItemStackList getNonEmptyStacks(EntityPlayer player, Predicate<ItemStack> predicate) {
		
		return getNonEmptyStacks(player, true, true, true, predicate);
	}
	
	public static ItemStackList getNonEmptyStacks(EntityPlayer player, boolean includeMain, boolean includeOffHand, boolean includeArmor) {
		
		return getNonEmptyStacks(player, includeMain, includeOffHand, includeArmor, s -> true);
	}
	
	public static ItemStackList getNonEmptyStacks(EntityPlayer player, boolean includeMain, boolean includeOffHand, boolean includeArmor, Predicate<ItemStack> predicate) {
	...
	/** @deprecated Renamed to getNonEmptyStacks */
	@Deprecated
	public static NonNullList<ItemStack> getNonNullStacks(EntityPlayer player, Predicate<ItemStack> predicate) {
	...
	/** @deprecated Renamed to getNonEmptyStacks */
	@Deprecated
	public static NonNullList<ItemStack> getNonNullStacks(EntityPlayer player, boolean includeMain, boolean includeOffHand, boolean includeArmor) {
	...
	/** @deprecated Renamed to getNonEmptyStacks */
	@Deprecated
	public static NonNullList<ItemStack> getNonNullStacks(EntityPlayer player, boolean includeMain, boolean includeOffHand, boolean includeArmor, Predicate<ItemStack> predicate) {
