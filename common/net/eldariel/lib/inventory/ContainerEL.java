package net.eldariel.lib.inventory;
...
public class ContainerEL extends Container {

	protected final IInventory tileInventory;
	
	public ContainerEL(InventoryPlayer playerInventory, IInventory tileInventory) {
