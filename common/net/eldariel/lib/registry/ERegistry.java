...
import net.eldariel.lib.item.ItemBlockEL;
...
public class ERegistry {
	...
	/** A reference to the mod's instance object. */
	 ...
	 /** The mod ID for the mod this ERegistry instance belongs to. */
	 ...
	 public ERegistry(String modId, LogHelper logHelper) {
	 ...
	 /**
	  * Register an IRegistryObject Block (BlockEL, etc.) Uses getName for this key.
	  */
	 ...
	 /*
	  * Register a Block. Its name (registry key/name) must be provided. Uses a new ItemBlockEL.
	  */
	 public <T extends Block> T registerBlock(T block, String key) {
		 
		 return registerBlock(block, key, new ItemBlockEL(block));
	 }
	 
	 /**
	  * Register an IRegistryObject Block (BlockEL, etc.) with a custom ItemBlock. Uses getName for its key.
	  */
	 ...
	 /**
	  * Register an IRegistryObject Item (ItemEL, etc.) Uses getName for its key.
	  */
	 ...
	 /***************************************************************************************
	  * TileEntity registration. These aren't Forge registries, but these need to be wrapped.
	  ***************************************************************************************/
	 ...
	 public void preInit() {
		 ...
		 if (mod == null) {
			 ...
			 if (container != null)
				 ...
				 logHelper.warning("ERegistry for this mod failed to get the mod instance! This coulde be because the provided mod ID is incorrect.");
		 }
	 }
	 ...
	 /**
	  * Handles the new Forge RegistryEvents. An instance will automatically be registered when an ERegistry is
	  * constructed
	  * 
	  * @author Eldariel
	  * @since 0.0.1
	 ...
	 public static class EventHandler {
		 ...
		 protected ERegistry eregistry;
		 
		 public EventHandler(ERegistry eregistry) {
		 ...
		 public void registerBlocks(RegistryEvent.Register<Block> event) {
			 ...
			 if (eregistry.handlerBlocks != null) {
				 eregistry.handlerBlocks.registerAll(eregistry);
			 }
		 }
		 ...
		 public void registerItems(RegistryEvent.Register<Item> event) {
			 ...
			 if (eregistry.handlerItems != null) {
				 eregistry.handlerItems.registerAll(eregistry);
			 }
			 
			 eregistry.addOreDictEntries();
		 }
	 ...
	 public void registerRecipes(RegistryEvent.Register<IRecipe> event) {
		 ...
		 if (eregistry.handlerRecipes != null) {
			 eregistry.handlerRecipes.registerAll(eregistry);
		 }
		 eregistry.addRecipes();
	 }
	 
	 @SubscribeEvent
	 public void registerModels(ModelRegistryEvent event) {
		 
		 eregistry.registerModels();
	 }
	 }
} 
