...
import net.eldariel.lib.block.BlockEL;
...
public class ItemBlockEL extends ItemBlock {
	...
	public EnumRarity getRarity(ItemStack stack) {
		...
		if (block instanceof BlockEL) {
			return ((BlockEL) block).getRarity(stack.getItemDamage());
		}
