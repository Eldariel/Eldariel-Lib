...
public class GuiEntry extends GuiGuide {
	...
	// The page in the entry. Say you have 2 more chapters than fit on a double page, then those 2 would be displayed on 
	// entryPage 1 instead.
	...
	public void onPageLeftButtonPressed() {
		...
		this.mc.displayGuiScreen(new GuiEntry(book, this.previousScreen, this.parentPage, this.entry, this.entryPage - 1, this.searchText, this.searchField.isFocused()));
	}
